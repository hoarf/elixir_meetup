defmodule ElixirMeetupWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule ElixirMeetup.MyChannel do
        use ElixirMeetupWeb, :channel
        alias ElixirMeetup.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :elixir_meetup,
                        pubsub_server: ElixirMeetup.PubSub
end
